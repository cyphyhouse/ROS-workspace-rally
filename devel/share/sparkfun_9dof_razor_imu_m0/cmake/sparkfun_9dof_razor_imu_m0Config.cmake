...
if("TRUE" STREQUAL "TRUE")
  set(sparkfun_9dof_razor_imu_m0_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/sparkfun_9dof_razor_imu_m0)
  set(sparkfun_9dof_razor_imu_m0_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel)
  ...
  set(sparkfun_9dof_razor_imu_m0_INSTALL_PREFIX /home/ubuntu/catkin_ws/install)
...
if(NOT "/home/ubuntu/catkin_ws/src/sparkfun_9dof_razor_imu_m0/include " STREQUAL " ")
  set(sparkfun_9dof_razor_imu_m0_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/catkin_ws/src/sparkfun_9dof_razor_imu_m0/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sparkfun_9dof_razor_imu_m0' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/sparkfun_9dof_razor_imu_m0/${idir}'.  Ask the maintainer 'Michael T. Boulet <boulet@ll.mit.edu>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${sparkfun_9dof_razor_imu_m0_dep}_FOUND)
      find_package(${sparkfun_9dof_razor_imu_m0_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${sparkfun_9dof_razor_imu_m0_dep} REQUIRED ${depend_list})
  endif()
