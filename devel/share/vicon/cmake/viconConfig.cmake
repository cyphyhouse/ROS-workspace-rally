...
if(NOT "/home/ubuntu/catkin_ws/devel/include;/usr/include/eigen3;/usr/include " STREQUAL " ")
  set(vicon_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/catkin_ws/devel/include;/usr/include/eigen3;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vicon' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/vicon/vicon/${idir}'.  Ask the maintainer 'Kartik Mohta <kmohta@seas.upenn.edu>, Chao Qu <quchao@seas.upenn.edu>' to fix it.")
    endif()
